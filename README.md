...
Попросите координатора вашего синдиката добавить вас как collaborator на этот репо.
Если не хотите ждать — сделайте fork и отправьте PR.
...
Добавьте или отредактируйте `openapi.yaml` в директории вашего домена.
...
Затем создайте Pull Request на GitHub. Координатор вашего синдиката проверит и смержит.
